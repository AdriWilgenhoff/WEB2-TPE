...
class Model {
    ...
    function deploy() {
        ...
        if (count($tables) == 0) {
			...
			--
			-- Host: 127.0.0.1
			-- Generation Time: Sep 29, 2024 at 12:34 AM
			...
			(3, 'México', 'Español', 'Peso Mexicano ($)'),
